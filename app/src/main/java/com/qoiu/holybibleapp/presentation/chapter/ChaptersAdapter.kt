...
class ChaptersAdapter(private val retry: Retry,private val clickListener: ChapterListener) : BaseAdapter<ChapterUi,BaseViewHolder<ChapterUi>>() {
    ...
    abstract class ChapterViewHolder(view: View) : BaseViewHolder<ChapterUi>(view) {
        ...
        class Base(view: View, private val clickListener: ChapterListener) : ChapterViewHolder(view) {
